...
<head>
    ...
    <meta name="title" content="كربتو السعودية">
    ...
    <meta property="og:title" content="كربتو السعودية">
    ...
    <meta property="twitter:title" content="كربتو السعودية">
...
<body>
            ...
            <div class="container text-white py-xl-5 center center-tablet">
                ...
                <div class="row justify-content-around">
                    <div class="col-lg-7 col-12 d-flex align-items-center order-2 mt-lg-0 mt-2 order-lg-1">
                        <div class="pe-lg-5">
                            <h1 class="text-center main-heading">أول منصة <span class="text-yellow">
                                    للعملات المشفرة
                                </span>في المملكة العربية السعودية
                            </h1>

                            <p class="text-center normal-para fw-600 mt-lg-4 mb-0 opacity-unset">
                ...
                <div class="tab-pane fade show active" id="step-1" role="tabpanel" aria-labelledby="step-1-tab">
                    <div class="row mt-lg-5 mt-3 justify-content-between text-center text-lg-start">
                        ...
                        <div class="col-lg-5 col-12 d-flex justify-content-center flex-column">
                            ...
                            <p class="mb-0 step-1">الخطوة-1</p>
                            <p class="heading"> <span class="text-yellow">كربتو</span>السعودية محفظة</p>
                            <p class="normal-para  mb-4 pb-3">بمجرد أن تسجل الدخول وتتحقق من حسابك، ستتمكن من الانتقال
                                إلى صفحة محافظنا (انقر فوق "المحفظة" في الأعلى)، وقم بعمل إيداع سريع نقدي أو بالعملة
                                المشفرة وابدأ التداول على الفور. "سهل"
                            </p>
                        </div>
                    </div>
                </div>
                <div class="tab-pane fade" id="step-2" role="tabpanel" aria-labelledby="step-2-tab">
                    <div class="row mt-lg-5  mt-3 justify-content-between text-center text-lg-start">
                        ...
                        <div class="col-lg-5 d-flex justify-content-center flex-column">
                            ...
                            <p class="mb-0 step-1">الخطوة-2</p>
                            <p class="heading"> <span class="text-yellow"> BTC</span>-USDT</p>
                            <p class="normal-para  mb-4 pb-3">للحصول على أفضل أسعار قابلة للتداول من أكثر من 40 بورصة
                                لمجموعة متنوعة من أزواج العملات الرقمية/العملات الحكومية، انتقل إلى صفحة الأسواق لدينا
                                (انقر على "تداول احترافي" في الأعلى) وستتمكن من تنفيذ الصفقات على الفور بسعر السوق.
                                يمكنك أيضًا وضع أوامر محددة الحد و/أو أوامر وقف على أي من الأزواج المتاحة.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="tab-pane fade" id="step-3" role="tabpanel" aria-labelledby="step-3-tab">
                    <div class="row mt-lg-5 mt-3 justify-content-between text-center text-lg-start">
                        ...
                        <div class="col-lg-5 d-flex justify-content-center flex-column">
                            ...
                            <p class="mb-0 step-1">الخطوة-3</p>
                            <p class="heading"> <span class="text-yellow">تداول </span> العملات الرقمية</p>
                            <p class="normal-para  mb-4 pb-3">قم بعمل صفقات سريعة (انقر على "تداول سريع" في الأعلى)
                                ببساطة عن طريق استبدال النقود بالعملات الرقمية، أو العملات الرقمية ببعضها البعض، أو
                                العملات الرقمية بالنقود.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="tab-pane fade" id="step-4" role="tabpanel" aria-labelledby="step-4-tab">
                    <div class="row mt-lg-5 mt-3 justify-content-between text-center text-lg-start">
                        ...
                        <div class="col-lg-5 d-flex justify-content-center flex-column">
                            ...
                            <p class="mb-0 step-1">الخطوة-4</p>
                            <p class="heading"> <span class="text-yellow">إرسال </span> عملة</p>
                            <p class="normal-para  mb-4 pb-3">لإرسال العملات الرقمية إلى أصدقائك وأحبائك، ما عليك سوى
                                العودة إلى صفحة المحافظ والنقر على "سحب" بجانب العملة الرقمية التي ترغب في إرسالها. قم
                                بملء تفاصيل عنوان المحفظة والمذكرة إذا لزم الأمر والمبلغ الذي ترغب في إرساله. كل ذلك
                                بسيط للغاية.
                            </p>
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="step-5" role="tabpanel" aria-labelledby="step-5-tab">
                    <div class="row mt-lg-5 mt-3 justify-content-between text-center text-lg-start">
                        ...
                        <div class="col-lg-5 d-flex justify-content-center flex-column">
                            ...
                            <p class="mb-0 step-1">الخطوة-5</p>
                            <p class="heading"> <span class="text-yellow">دعوة</span> صديق</p>
                            <p class="normal-para  mb-4 pb-3">قم بإحالة الأصدقاء والزملاء الذين ترغب فيهم واربح ما يصل
                                إلى 500 دولار أمريكي أسبوعيًا من رسوم التحويل.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row text-center text-lg-start justify-content-lg-between">
                <div class="col-lg-6 col-12 order-2 order-lg-1">
                    <div class="mt-5 mt-lg-0 ">
                        <h1 class="heading px-4 px-sm-0">قم بتحميل تطبيق <span class="text-yellow">
                                كربتو السعودية</span> للجوال </h1>
                        <p class="normal-para mb-5 mt-4 pe-lg-5 me-lg-5">من السهل والسريع الاستخدام. تطبيق كربتو
                            السعودية يتيح لك إجراء الإيداعات والسحوبات الفورية، كما يمكنك أيضًا استخدام عملية الدفع برمز
                            الاستجابة السريعة للمحفظة لإرسال أكثر من 50 عملة رقمية كوسيلة للدفع عند الحاجة..</p>
                        <div class=" ">
    ...
    <section class="mt-lg-4 mt-3 pt-5">
        <div class="container carousel ">
            <h1 class="heading text-center mb-4 pb-lg-3">
                اكسب يوميا مع <span class="text-yellow">
                    كربتو السعودية</span>
            </h1>
                    ...
                    <div class="card-1">
                        <div class="text-center">
                            ...
                            <h4 class="sub-heading mt-4">
                                مُصمّم باستخدام أحدث التقنيات
                            </h4>
                            <p class="normal-para my-4">
                                البقاء في الصدارة والبقاء على اطلاع دائم مع أفضل تقنيات التداول المتاحة
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-1">
                        <div class="text-center">
                            ...
                            <div>
                                ...
                                <p class="normal-para my-4">
                                    بناء عالم بلا حدود من خلال تداول العملات المشفرة الدولي
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-4 col-md-6 col-12 mt-4">
                    <div class="card-1">
                        <div class="text-center">
                            ...
                            <p class="normal-para my-4">
                                تداول العملات المحلية الخاصة بك مقابل بيتكوين وغيرها من الأصول الرقمية الرئيسية
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section class="koinkoin-trading py-5">
        <div class="container mb-4">
            <h1 class="heading mt-3 mb-4 text-center px-4 px-sm-0">تداول الشركات عبر الطاولة في كربتو السعودية </h1>
            <div class="row justify-content-center">
                <div class="col-lg-4 col-sm-6 col-12 mt-4 mt-lg-0">
                    <div class="card-2">
                        ...
                        <h4 class="small-heading">
                            وصول حصري إلى أفضل الصفقات
                        </h4>
                        <p class="normal-para mt-3 mb-4 pb-3">
                            احصل على صفقات حصرية وعالية الجودة بأمان مباشرةً في منصتنا.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 col-12  mt-4 mt-lg-0">
                    <div class="card-2">
                        ...
                        <h4 class="small-heading">
                            عمليات قابلة للتدقيق، بيئة تداول آمنة
                        </h4>
                        <p class="normal-para mt-3 mb-4 pb-3">
                            يتم فحص جميع التجار الذين يستخدمون منصتنا بشكل كامل لضمان بيئة تداول آمنة ومأمونة
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 col-12  mt-4 mt-lg-0">
                    <div class="card-2">
                        ...
                        <p class="normal-para mt-3 ">
                            طبقت كربتو السعودية سياسة صارمة للسرية لكل عرض، صفقة، وعرض مضاد داخل المنصة. يتم التعامل مع
                            جميع المعاملات بدرجة عالية من الخصوصية.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 col-12 mt-4 mt-lg-0">
                    <div class="card-2">
                        ...
                        <h4 class="small-heading">
                            سيولة أكبر مع الامتثال للمستوى المؤسسي
                        </h4>
                        <p class="normal-para mt-3 mb-4 pb-3">
                            لقد عقدنا شراكة مع OTCTrade لضمان الامتثال وضمان سيولة أكبر لعملائنا.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-lg-6 col-12 ps-4">
                    <h3 class="heading text-center text-lg-start mt-4 mt-lg-0">
                        تداول <span class="text-yellow">
                            العملات المشرفرة
                        </span> بالعملة المحلية بسهولة
                    </h3>
                    <div class="d-flex trade-hover mt-5">
                        <div class="pe-4">
                        ...
                        <div class="ps-2">
                            ...
                            <p class="normal-para">
                                تعال كما أنت. لا توجد متطلبات سوى بريدك الإلكتروني لفتح الحساب.
                            </p>
                        </div>
                    </div>
                    <div class="d-flex trade-hover">
                        <div class="pe-4">
                        ...
                        <div class="ps-2">
                            <p class="small-heading mb-0 trade-text  ">
                                قم بإيداع العملات المشفرة / العملات المحلية
                            </p>
                            <p class="normal-para">
                                قم بإيداع العملة المحلية الخاصة بك أو ببساطة قم بتحويل عملتك المشفرة إلى عنوانك في كربتو
                                السعودية.
                            </p>
                        </div>
                    </div>
                    <div class="d-flex trade-hover">
                        ...
                        <div class="ps-2">
                            <p class="small-heading mb-0 trade-text ">
                                شراء / بيع العملات المشفرة
                            </p>
                            <p class="normal-para">
                                ابدأ التداول. قم بشراء، بيع وتحويل أكبر الأصول الرقمية.
                            </p>
                        </div>
                    </div>
                    <div class="mt-4 text-center text-lg-start">
                        <a class="blue-btn text-decoration-none" href="{{ url('ar/signup') }}">
                            انشاء حساب
                        </a>
                    </div>
                </div>
                            ...
                            <div class="accordion-item  mt-2  ">
                                <h2 class="accordion-header" id="headingone">
                                    <button class="accordion-button border-0 collapsed small-heading" type="button"
                                        ...
                                        هل يمكنني إنشاء حساب على كربتو السعودية من أي مكان في العالم؟
                                    </button>
                                </h2>
                                <div id="collapseone" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body ">
                                        <p class="accordion-para normal-para">
                                            نعم، يمكنك ذلك. يوفر كربتو السعودية وصولًا إلى محافظ العملات المشفرة لدينا
                                            المتميزة للحفاظ على أصول عملتك المشفرة بأمان أينما كنت موجودًا.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item   mt-2">
                                <h2 class="accordion-header" id="headingTwo">
                                    <button class="accordion-button border-0 collapsed small-heading" type="button"
                                        ...
                                        هل يمكنني إيداع USDT وشراء عملات رقمية أخرى على كريبتوسا؟
                                    </button>
                                </h2>
                                <div id="collapseTwo" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body ">
                                        <p class="accordion-para normal-para mt-2">
                                            نعم يمكنك، يمكنك تحويل USDT الخاص بك إلينا باستخدام عناوين ERC20 و/أو TRC20
                                            أو ببساطة مسح وإرسال عبر رمز الاستجابة السريعة المعروض على شاشة الإيداع.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item  mt-2 ">
                                <h2 class="accordion-header" id="headingthree">
                                    <button class="accordion-button border-0 collapsed small-heading" type="button"
                                        ...
                                        هل يسمح لي كريبتوسا بوضع طلبات كبيرة بالعملة الحكومية لشراء العملات المشفرة؟
                                    </button>
                                </h2>
                                <div id="collapsethree" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body ">
                                        <p class="accordion-para normal-para mt-2">
                                            نعم، نحن نفعل. كريبتوسا تقدم خدمة OTC قوية، ما عليك سوى مراسلتنا برسالة
                                            بسيطة على support@Kryptosa.com وسنخبرك ما إذا كنت مؤهلاً أم لا.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div id="collapsefour" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body ">
                                        <p class="accordion-para mt-2 normal-para">
                                            نعم، يمكنك، يمكنك سحب عملاتك المشفرة إلى محفظة أخرى مباشرةً. إذا كان لديك أي
                                            مشكلات مع هذه العملية، يمكنك مراسلة فريق الدعم عبر البريد الإلكتروني -
                ...
                <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                    ...
                    <div class="d-flex mt-4 head-office">
                        ...
                        <div class="mx-3 mx-sm-0">
                            ...
                            <p class="normal-para mb-2">
                                كريبتوسا، شارع الأمير سلطان، جدة، المملكة العربية السعودية
                            </p>
                            <!-- <p>
                                +1 123 123 123 0
                            </p> -->
                    ...
                    <div class="d-flex mt-4 head-office">
                        ...
                        <div class="mx-3 mx-sm-0">
                            ...
                            <p class="normal-para mb-2">
                                كربتوسا 6318 <br>
                                ساحة إعمار، المبنى رقم 4 <br>
                                شارع الشيخ محمد بن راشد، دبي، الإمارات العربية المتحدة
                            </p>
                            <!-- <p>
                                +1 123 123 123 0
                            </p> -->
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-2 col-sm-4 col-6 mt-3 text-center">
                    <ul class="list-unstyled">
                        ...
                        <li class="my-2">
                            <a class="footer-link" href="{{ url('ar/signup') }}">
                                انشاء حساب
                            </a>
                        </li>
                        <li class="my-2">
